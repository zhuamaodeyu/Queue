...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.2.0/x86_64-darwin18")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/akulaku/Desktop/CocoaPods-app/destroot/bundle")
  ...
  CONFIG["configure_args"] = " '--prefix' '/Users/akulaku/Desktop/CocoaPods-app/destroot/bundle' '--enable-load-relative' '--disable-shared' '--with-static-linked-ext' '--disable-install-doc' '--without-ext=,dbm,gdbm,sdbm,dl/win32,fiddle/win32,tk/tkutil,tk,win32ole,-test-/win32/dln,-test-/win32/fd_setsize,-test-/win32/dln/empty' 'CC=/usr/bin/clang' 'CFLAGS=-mmacosx-version-min=10.10 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk' 'LDFLAGS=-L/Users/akulaku/Desktop/CocoaPods-app/destroot/dependencies/lib' 'CPPFLAGS=-I/Users/akulaku/Desktop/CocoaPods-app/destroot/dependencies/include' 'CXX=/usr/bin/clang++'"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/akulaku/Desktop/CocoaPods-app/destroot/dependencies/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/akulaku/Desktop/CocoaPods-app/destroot/dependencies/lib -fstack-protector"
  CONFIG["CFLAGS"] = "-mmacosx-version-min=10.10 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk -pipe"
  ...
  CONFIG["target_os"] = "darwin18"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "x86_64"
  CONFIG["target"] = "x86_64-apple-darwin18"
  CONFIG["host_os"] = "darwin18.6.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-apple-darwin18.6.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin18.6.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin18.6.0"
